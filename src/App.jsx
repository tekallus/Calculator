...
export default function App() {
  ...
  Sayı butonları çalışmıyor çünkü currentCalc state'i güncellemiyorlar. Amacınız aşağıdakileri yaparak bunu düzeltmektir: 
...
---------------Aşağıdaki 1. görev için kodunuzu yazın.------------------------------------------------*/
        /*numFromClick değeri, currentCalc'ın currentNum array'ine eklenmelidir.
Array'de zaten kayıtlı olan değerler korunmalıdır.
currentCalc'ın diğer tüm özellikleri korunmalıdır.*/
...
---------------Aşağıdaki 2. görev için kodunuzu yazın.------------------------------------------------*/
        /*numFromClick değeri, currentCalc'ın currentNum array'ine eklenmelidir.
Dizideki önceki değerler korunmamalıdır - numFromClick değeri dizideki tek değer haline gelmelidir.
currentCalc'ın diğer tüm özellikleri, INITIAL_STATE içinde kaydedilen ilk değerlere geri döndürülmelidir.
*/
        setCurrentCalc({
          ...INITIAL_STATE,
...
---------------Aşağıdaki 3. görev için kodunuzu yazın.------------------------------------------------*/
        /*currentCalc'ın sonuç array'ine kaydedilen değer, boş previousNum array'ine eklenmeli ve sonuç array'i boş hale getirilmelidir.
numFromClick değeri boş currentNum array'ine kaydedilmelidir.
operation değeri (bir string) korunmalıdır.*/
        setCurrentCalc((prevCalc) => ({
